...
<body>
    ...
    <div class="footer container">
            ...
            <div class="img"></div>
            <div class="text">XTREME<span>MUSIX</span></div</div>
        <p class="desc"> Hallo!, Kami dari Kelompok Developer Kecil-Kecilan yang sedang merintis jalur usaha kami dengan membuat sebuah website yang dapat menyaingi website-website streaming music lainnya. Walaupun kami masih pemula, tapi kami yakin. suatu saat, dimasa yang akan datang nanti nama kami akan dikenang sebagai salah satu pencatat sejarah baru dalam dunia perwebsite-an</p>
        </div>
